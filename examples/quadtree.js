...
var ASM_CONSTS = {
  ...
  var CurrentModuleWeakSymbols = new Set(["p8g_key_pressed","p8g_key_released","p8g_mouse_pressed","p8g_mouse_released","p8g_mouse_wheel"]);
  ...
  var ___stack_pointer = new WebAssembly.Global({'value': 'i32', 'mutable': true}, 5255232);
  ...
  function _p8g_random(
  ) {
  if (!Module['_p8g_random']) abort("external symbol 'p8g_random' is missing. perhaps a side module was not linked in? if this function was expected to arrive from a system library, try to build the MAIN_MODULE with EMCC_FORCE_STDLIBS=1 in the environment");
  return Module['_p8g_random'].apply(null, arguments);
  }
  _p8g_random.stub = true;
  ...
  function _stbds_arrgrowf(
  ) {
  if (!Module['_stbds_arrgrowf']) abort("external symbol 'stbds_arrgrowf' is missing. perhaps a side module was not linked in? if this function was expected to arrive from a system library, try to build the MAIN_MODULE with EMCC_FORCE_STDLIBS=1 in the environment");
  return Module['_stbds_arrgrowf'].apply(null, arguments);
  }
  _stbds_arrgrowf.stub = true;
...
var asmLibraryArg = {
  ...
  "p8g_no_fill": _p8g_no_fill,
  "p8g_peek_color_mode": _p8g_peek_color_mode,
  "p8g_point": _p8g_point,
  "p8g_pop": _p8g_pop,
  "p8g_push": _p8g_push,
  "p8g_random": _p8g_random,
  "p8g_rect": _p8g_rect,
  "p8g_rect_mode": _p8g_rect_mode,
  "p8g_run": _p8g_run,
  "p8g_stroke": _p8g_stroke,
  "p8g_stroke_weight": _p8g_stroke_weight,
  "p8g_width": _p8g_width,
  "setTempRet0": _setTempRet0,
  "stbds_arrgrowf": _stbds_arrgrowf
};
var asm = createWasm();
/** @type {function(...*):?} */
...
var _stderr = Module['_stderr'] = 11616;
...
function stackCheckInit() {
  ...
  // here.
  _emscripten_stack_set_limits(5255232 , 12352);
