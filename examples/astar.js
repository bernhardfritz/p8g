...
var ASM_CONSTS = {
  ...
  __ZN3p8g10backgroundEf.stub = true;
  ...
  function ___cxa_throw(ptr, type, destructor) {
      ...
      throw ptr + " - Exception catching is disabled, this exception cannot be caught. Compile with -sNO_DISABLE_EXCEPTION_CATCHING or -sEXCEPTION_CATCHING_ALLOWED=[..] to catch." + " (note: in dynamic linking, if a side module wants exceptions, the main module must be built with that support)";
    }
  ...
  var ___stack_pointer = new WebAssembly.Global({'value': 'i32', 'mutable': true}, 5255840);
  ...
  function _p8g_no_tint(
  ) {
  if (!Module['_p8g_no_tint']) abort("external symbol 'p8g_no_tint' is missing. perhaps a side module was not linked in? if this function was expected to arrive from a system library, try to build the MAIN_MODULE with EMCC_FORCE_STDLIBS=1 in the environment");
  return Module['_p8g_no_tint'].apply(null, arguments);
  }
  _p8g_no_tint.stub = true;
  ...
  function _p8g_random_seed(
  ) {
  if (!Module['_p8g_random_seed']) abort("external symbol 'p8g_random_seed' is missing. perhaps a side module was not linked in? if this function was expected to arrive from a system library, try to build the MAIN_MODULE with EMCC_FORCE_STDLIBS=1 in the environment");
  return Module['_p8g_random_seed'].apply(null, arguments);
  }
  _p8g_random_seed.stub = true;
  ...
  if (!Module['_p8g_tint']) abort("external symbol 'p8g_tint' is missing. perhaps a side module was not linked in? if this function was expected to arrive from a system library, try to build the MAIN_MODULE with EMCC_FORCE_STDLIBS=1 in the environment");
  return Module['_p8g_tint'].apply(null, arguments);
  }
  _p8g_tint.stub = true;
...
var _stderr = Module['_stderr'] = 11888;
...
function stackCheckInit() {
  ...
  // here.
  _emscripten_stack_set_limits(5255840 , 12960);
